...
public class MenuMedicoController implements Initializable {
    ...
    @FXML
    private Button cadastrarCouI;
    @FXML
    private Button validarAtendimento;
    ...
    @FXML
    private void botaoCadastrarCouI(ActionEvent event) {
        application.CadastrarCirurgiaInternacao(application.getUsuarioLogado(), true);
    }

    @FXML
    private void botaoValidarAtendimento(ActionEvent event) {
        application.ValidarAtendimento(application.getUsuarioLogado(), true);
    }
